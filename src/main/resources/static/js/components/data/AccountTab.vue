                ...
                <b-list-group>
                    <b-list-group-item>
                        <dl class="row">
                            ...
                            <dd class="col-sm-9"><em>{{accountInfo.type}}</em></dd>
                        </dl>
                    </b-list-group-item>
                    <b-list-group-item>
                        <dl class="row">
                            <dt class="col-sm-3">Currency:</dt>
                            <dd class="col-sm-9"><em>{{accountInfo.currency}}</em></dd>
                        </dl>
                    </b-list-group-item>
                    <!--TODO сделать карты-->
                    <!--<b-list-group-item>-->
                        <!--<dl class="row">-->
                            ...
                            <!--<dd class="col-sm-9"><em>{{accountInfo.cardNumber | 'No CARD'}}</em></dd>-->
                        <!--</dl>-->
                    <!--</b-list-group-item>-->
                    <b-list-group-item>
                        <dl class="row">
                            <dt class="col-sm-3">Last updated:</dt>
                            <dd class="col-sm-9"><em>{{ moment(accountInfo.updateAt).format('LLL') }}</em></dd>
                        </dl>
                    </b-list-group-item>
                    <b-list-group-item>
                        <dl class="row">
